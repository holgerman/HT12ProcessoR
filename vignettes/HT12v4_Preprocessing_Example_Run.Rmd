...
# here::dr_here(show_reason = T) #  the here package makes the navigation in directories easier but works best from whitin R-Projects
...
# location to example data
data.directory <- path.package("HT12ProcessoR")
...
my.con_f <- c(paste0(data.directory, "/extdata/Run12_ControlProbeProfile_590-651.txt"), # control probe measurements + ercc (spike-in -- class of control probes)
              paste0(data.directory, "/extdata/ControlProbeProfile_HSS106-HSS155.txt")) #  second example (processing batch 1 & 2)

# gene probe file
my.nobkgd_f <- c(paste0(data.directory, "/extdata/Run12_nonorm_nobkgd_590-651.txt"), # raw probe data of human gene expression 
                 paste0(data.directory, "/extdata/Einzelanalyse_nonorm_nobkgd_HSS106-HSS155.txt"))

# sample file
my.sample_f <- c(paste0(data.directory, "/extdata/Run12_SamplesTable_590-651.txt"), # sample annotation (each measured indiviuum)
                 paste0(data.directory, "/extdata/SamplesTable_HSS106-HSS155.txt"))
...
```{r parameter.file}
myparams <- read.delim(paste0(data.directory, "/extdata/input_parameter_010.txt"),
                       as.is = T)
```
...
renaming_fn <- paste0(data.directory, "/extdata/renamingsamples.txt")
